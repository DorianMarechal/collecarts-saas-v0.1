...
import { makeSignupFormSchema, SignupFormType } from "@/schemas/signup-schema"
...
// TODO: FINIR LA CONFIRMATION EMAIL
...
export function SignupForm({
  ...
  const form = useForm<SignupFormType>({
    resolver: zodResolver(makeSignupFormSchema()),
    mode: "onChange",
          ...
          <form className="p-6 md:p-8" onSubmit={form.handleSubmit(handleSubmit)}>
            <FieldGroup>
              ...
              <Field>
                ...
                <FieldError>{errors.password?.message || errors.confirmPassword?.message}</FieldError>
              </Field>
              <Field>
